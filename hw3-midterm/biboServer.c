...
int childrenPids[CLIENT_SIZE];  //child pid array
...
int main(int argc, char **argv){
    ...
    while(keepRunning){
        ...
        //child--------------------------------------------------------------------------------
            ...
            //connect or try connect and queue is not avaliable -----------------------------------------------------
            if( (strcmp(biboClient.connectInfo, "Connect") == 0) || (strcmp(biboClient.connectInfo, "tryConnect") == 0) ){
...
//reads client request and gives the response through clietn fifo
    ...
    while(1){
        ...
        //other valid requests----------------------------------------------------------------
            ...
            //writeT command entered
                ...
                responseTemp = "writeT is a valid command but it is not supported for this implementation.\n";
            }
...
char* help_command(int key, char* command){
    ...
    //give the details for required command
        ...
        if(strcmp(command, "help") == 0){
            ...
            sprintf(response, "Command '%s' is not supported.\n", command);
        }
    }
    return response;
}
...
int getArguments(int argc, char **argv){
    ...
    if(argc != 3){
        perror("Usage: There should be 3 console arguments. [biboServer <dirname> <maxNumOfClients>]");
        return -1;
    }
